...
import com.zane001.happyweather.ui.adapter.CityAdapter;
...
import com.zane001.happyweather.widget.jazzylistview.JazzyListView;
...
public class CityActivity extends SwipeBackActivity {
    ...
    void getProvinceList() {
        ...
        baseCityModels.addAll(App.getProvinceModels());
    ...
    private List<CityModel> getCurCityList(String id) {
        for (ProvinceModel model : App.getProvinceModels()) {
