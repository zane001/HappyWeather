...
public final class Crouton {
    ...
    private Crouton(Activity activity, View customView) {
        ...
        this.style = new Style.Builder().setHeight(LayoutParams.MATCH_PARENT).build();
        this.text = null;
    }
    ...
    /**
     * Clears (and removes from {@link android.app.Activity}'s content view, if necessary)
     * all croutons for the provided activity
     * 
     * @param activity - The {@link android.app.Activity} to clear the croutons for.
     */
    ...
    private FrameLayout initializeCroutonViewGroup(Resources resources) {
        ...
        if (this.style.backgroundColorValue != Style.NOT_SET) {
            ...
            croutonView
                    .setBackgroundColor(resources.getColor(this.style.backgroundColorResourceId));
        }
