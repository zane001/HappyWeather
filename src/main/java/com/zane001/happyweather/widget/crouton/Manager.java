...
final class Manager extends Handler {
    ...
    /**
     * Sends a {@link Crouton} within a {@link android.os.Message}.
     * 
    ...
    /**
     * Sends a {@link Crouton} within a delayed {@link android.os.Message}.
     * 
     * @param crouton The {@link Crouton} that should be sent.
     * @param messageId The {@link android.os.Message} id.
    ...
    /**
     * Adds a {@link Crouton} to the {@link android.view.ViewParent} of it's {@link android.app.Activity}
     * .
     * 
    ...
    private void handleTranslucentActionBar(ViewGroup.MarginLayoutParams params, Activity activity) {
        ...
        // final int translucentStatusFlag =
        // WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS;
        // /* Checks whether translucent status is enabled for this window.
        // * If true, sets the top margin to show the crouton just below the
        // action bar. */
        // if ((flags & translucentStatusFlag) == translucentStatusFlag) {
        // final int actionBarContainerId =
        // Resources.getSystem().getIdentifier("action_bar_container", "id",
        // "android");
        // final View actionBarContainer =
        // activity.findViewById(actionBarContainerId);
     ...
     * 
     * @param crouton The {@link Crouton} added to a {@link android.view.ViewGroup} and
     *            should be removed.
     */
