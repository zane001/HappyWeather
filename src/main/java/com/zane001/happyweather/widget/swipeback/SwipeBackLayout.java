...
package com.zane001.happyweather.widget.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link swipebacklayout.lib.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link swipebacklayout.lib.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
